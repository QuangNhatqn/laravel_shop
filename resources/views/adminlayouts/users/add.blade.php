...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            @include('adminlayouts.partials.content-header', ['name' => 'User', 'key' => 'Add', 'link' => route('users.index')])

            <form class="form-horizontal r-separator" action="{{route('users.store')}}" method="post"
