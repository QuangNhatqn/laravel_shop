...
@section('content')
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            @include('adminlayouts.partials.content-header', ['name' => 'Role', 'key' => 'Add', 'link' => route('roles.index')])

            <form class="form-horizontal r-separator" action="{{route('roles.store')}}" method="post"
                    ...
                    <div class="form-group row align-items-center m-b-0">
                        ...
                        <div class="col-9 border-left p-b-10 p-t-10">
                            <textarea class="form-control @error('display_name') is-invalid @enderror"
                                      ...
                                      name="display_name"
                                      id="display_name"
                                      placeholder="Description...">{{old('display_name')}}</textarea>
                            @error('display_name')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
