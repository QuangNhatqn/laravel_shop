                ...
                <div class="col-lg-4">
                    <div class="footer-widgets_info">
                        ...
                        <div class="footer-widgets_logo">
                            <a href="#">
                                <img src="{{asset('/customerlayouts_assets/images/footer/logo/1.png') }}" alt="Hiraola's Footer Logo">
                            </a>
                        </div>
            ...
            <div class="footer-bottom_nav">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="payment">
                            <a href="#">
                                <img src="/customerlayouts_assets/images/footer/payment/1.png" alt="Hiraola's Payment Method">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
...
<!-- Mirrored from demo.hasthemes.com/hiraola-preview/hiraola/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Apr 2021 11:49:34 GMT -->
</html>
