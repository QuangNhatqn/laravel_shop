                ...
                <div class="hiraola-product_slider">
                        ...
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-1.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-2.jpg" alt="Hiraola's Product Image">
                                </a>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-3.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-4.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker">New</span>
                                <div class="add-actions">
                                    <ul>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-5.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-6.jpg" alt="Hiraola's Product Image">
                                </a>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-7.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-8.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker">New</span>
                                <div class="add-actions">
                                    <ul>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-9.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-1.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker-2">Sale</span>
                                <div class="add-actions">
                                    <ul>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-2.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-9.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker">New</span>
                                <div class="add-actions">
                                    <ul>
                    ...
                    <div class="slide-item">
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-5.jpg" alt="Hiraola's Product Image">
                                    <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-3.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker">New</span>
                                <div class="add-actions">
                                    <ul>
                        ...
                        <div class="hiraola-product-tab_slider-2">
                            ...
                            <div class="slide-item">
                                <div class="single_product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-8.jpg" alt="Hiraola's Product Image">
                                            <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-5.jpg" alt="Hiraola's Product Image">
                                        </a>
                                        <span class="sticker">New</span>
                                        <div class="add-actions">
                                            <ul>
                            ...
                            <div class="slide-item">
                                <div class="single_product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-4.jpg" alt="Hiraola's Product Image">
                                            <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-7.jpg" alt="Hiraola's Product Image">
                                        </a>
                                        <div class="add-actions">
                                            <ul>
                                                <li><a class="hiraola-add_cart" href="cart.html" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="ion-bag"></i></a>
                        ...
                        <div class="hiraola-product-tab_slider-2">
                            ...
                            <div class="slide-item">
                                <div class="single_product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img" src="/customerlayouts_assets/images/product/medium-size/1-6.jpg" alt="Hiraola's Product Image">
                                            <img class="secondary-img" src="/customerlayouts_assets/images/product/medium-size/1-2.jpg" alt="Hiraola's Product Image">
                                        </a>
                                        <div class="add-actions">
                                            <ul>
            ...
            <div class="col-lg-6">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="/customerlayouts_assets/images/banner/1_5.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="/customerlayouts_assets/images/banner/1_6.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
        </div>
